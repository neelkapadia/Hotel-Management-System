 ...
 * @author neelkapadia
 */
public class ManageRoomPrice extends javax.swing.JFrame {

    /**
     * Creates new form ManageRoom
     */
    public ManageRoomPrice() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        deleteRoom.setText("Delete Room Price");
        ...
        addRoom.setText("Add Room Price");
        ...
        updateRoom.setText("Update Room Price");
        ...
        viewRoom.setText("View Room Price");
    ...
    private void submitRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitRoomActionPerformed
        ...
        if(addRoom.isSelected()){
            ...
            AddRoomPrice adc = new AddRoomPrice();
            sysExit();
            adc.setVisible(true);

        } else if(updateRoom.isSelected()){
            //open update record form
            UpdateRoomPrice upc = new UpdateRoomPrice();
            sysExit();
            upc.setVisible(true);
        } else if(deleteRoom.isSelected()){

            DeleteRoomPrice dlc = new DeleteRoomPrice();
            sysExit();
            dlc.setVisible(true);
            ...
            ViewRoomPrice dlc = new ViewRoomPrice();
            sysExit();
            dlc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageRoomPrice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageRoomPrice().setVisible(true);
            }
        });
    }
